...
#        bart1 = " ".join(bart1.split()) #+ #' ' + entities1
        ...
        comment_text1 = text_cleaner(comment_text1)
...
#        bart2 = " ".join(bart2.split()) #+ #' ' + entities1
        ...
        comment_text2 = text_cleaner(comment_text2)
        # print(comment_text2)
#        entities = []
...
#    import pdb;pdb.set_trace()
    if 'test' in mode:
        ...
        test_df.to_csv(os.path.join(output_dir, mode + '_predictions.csv'))
    else:
        train_df['PredictedOverall'] = pred_scores
        train_df.to_csv(os.path.join(output_dir, mode + '_predictions.csv'))
...
#    
    ...
    # training_loader_test = DataLoader(training_set, **test_params)
